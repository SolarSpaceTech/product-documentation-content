...
# Пример полного мета описания статьи с `historyDescription`
...
order: 6
published: true
historyName: Управление уведомлениями
historyDescription: Настройте уведомления, чтобы быть в курсе важных событий
---
# Настройка уведомлений

В этом разделе описано, как настроить уведомления для получения актуальной информации...
```

- **`historyDescription`:** "Настройте уведомления, чтобы быть в курсе важных событий" предоставляет пользователю понятное описание содержания статьи.
