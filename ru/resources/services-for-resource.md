---
id: 248
seoTitle: Сервисы сайта
seoDescription: Сервисы для базовой кибергигиены вашего бизнеса. Обеспечьте безопасность сайта и внешнего периметра, защитите от веб-атак и фишинга
displayName: Сервисы
order: 3
published: true
historyName: Сервисы
...
Чтобы открыть управление сервисами, перейдите на страницу «Мои сайты».
В строке нужного сайта откройте меню действий `«⋯»` и выберите пункт **«Сервисы»**.

![Open site services from My sites page(95%)](https://img.solarspace.pro/docs/partners/resources/my-sites-open-services.png "Открытие управления сервисами со страницы «Мои сайты»")
...
![Service cards and navigation(95%)](https://img.solarspace.pro/docs/partners/resources/site-services-cards-navigation.png "Сервисы веб-защиты и переход к настройкам")
...
![Advanced settings toggle(95%)](https://img.solarspace.pro/docs/partners/resources/site-services-advanced-settings.png "Переключатель «Расширенные настройки»")
...
![ScanGuard section(95%)](https://img.solarspace.pro/docs/partners/resources/site-services-scanguard.png "Раздел ScanGuard")
...
![SSL certificate settings(95%)](https://img.solarspace.pro/docs/partners/resources/site-services-certificates.png "Раздел «Сертификаты» и используемый SSL-сертификат")
...
![Target IP settings(95%)](https://img.solarspace.pro/docs/partners/resources/site-services-target-ip.png "Раздел «Целевой IP»")
...
![Adding a target IP(95%)](https://img.solarspace.pro/docs/partners/resources/site-services-target-ip-add.png "Добавление целевого IP-адреса и порта")
...
![AntiDDoS settings(95%)](https://img.solarspace.pro/docs/partners/resources/site-services-antiddos.png "Настройки сервиса AntiDDoS")
...
![Antibot settings(95%)](https://img.solarspace.pro/docs/partners/resources/site-services-antibot.png "Настройки сервиса Antibot")
...
![Antibot settings(95%)](https://img.solarspace.pro/docs/partners/resources/site-services-antibot-1.png "Настройки сервиса Antibot")
...
![WAF Lite settings(95%)](https://img.solarspace.pro/docs/partners/resources/site-services-waf-lite.png "Настройки сервиса WAF Lite")
...
![WAF Lite settings(95%)](https://img.solarspace.pro/docs/partners/resources/site-services-waf-lite-1.png "Настройки сервиса WAF Lite")
...
![HTTP headers settings(95%)](https://img.solarspace.pro/docs/partners/resources/site-services-http-headers.png "Настройка HTTP-заголовков")
...
![Access restrictions settings(95%)](https://img.solarspace.pro/docs/partners/resources/site-services-access-restrictions.png "Ограничения доступа по странам и спискам IP-адресов")
