...
![Start form for password reset(35%)](https://img.solarspace.pro/docs/forget-pswd-button.jpg)
3. В поле "Email" введите электронную почту, которую вы использовали при регистрации и нажмите на кнопку "Отправить".
![Email to the password reset form(35%)](https://img.solarspace.pro/docs/reset-pswd-email.jpg)
...
![Captcha for the password reset form(35%)](https://img.solarspace.pro/docs/reset-pswd-captcha.jpg)
...
![Email message for password reset(35%)](https://img.solarspace.pro/docs/reset-pswd-email-message.jpg)
...
![Confirmation code to the password reset form(35%)](https://img.solarspace.pro/docs/reset-pswd-confirmation-code.jpg)
...
![New password on the password reset form(35%)](https://img.solarspace.pro/docs/create-new-pswd.jpg)
...
![Success changing password form(35%)](https://img.solarspace.pro/docs/new-pswd-created.jpg)