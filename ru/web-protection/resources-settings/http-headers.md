...
![Web protection for HTTP headers (95%)](https://img.solarspace.pro/docs/on-prem/web-protection/settings/web-protection-http-headers.png "Веб-защита — HTTP-заголовки")
...
![http-header added (95%)](https://img.solarspace.pro/docs/on-prem/web-protection/settings/http-header-added.png "Сохранение HTTP-заголовка")
