...
![Перенаправление трафика(100%)]( https://img.solarspace.pro/docs/partners/quick-start/A-recordings.png "Перенаправление трафика")

В появившемся окне скопируйте указанный IP-адрес из поля DNS-A — именно его нужно будет использовать в настройках DNS.

![Перенаправление трафика(100%)]( https://img.solarspace.pro/docs/partners/quick-start/redirection.png "Перенаправление трафика")
...
После того как вы добавили A-запись у вашего DNS-провайдера, необходимо нажать кнопку "Подтвердить" в окне " Перенаправление трафика" — это активирует проверку записей и запускает защиту.
