...
![Filters for Requests tab(95%)](https://img.solarspace.pro/docs/saas/statistics/statistics-requests.png "Фильтры для вкладки «Запросы»")
...
![Type of requests for Requests tab(95%)](https://img.solarspace.pro/docs/saas/statistics/statistics-requests-2.png "Типы запросов для вкладки «Запросы»")

Нажимая на название типа запроса, вы можете исключить его из графика.  
В этом случае название станет серым.  Чтобы вернуть отображение, повторно нажмите на него.
...
Нажимая на название типа запроса, вы можете исключить его из графика.  
В этом случае название станет серым.  Чтобы вернуть отображение, повторно нажмите на его название.
