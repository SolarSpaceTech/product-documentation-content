...
![Filters for Bandwidth tab(75%)](https://img.solarspace.pro/docs/statistics-bandwidth.jpg "Фильтры ширины канала")
...
![Traffics for Bandwidth tab(75%)](https://img.solarspace.pro/docs/statistics-bandwidth-full-2.jpg "Трафики ширины канала")
