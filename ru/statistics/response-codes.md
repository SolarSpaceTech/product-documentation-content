...
seoDescription: Коды — анализ взаимодействия пользователей с сервером. Узнайте, какие коды наиболее часто используются на вашем сайте, и оптимизируйте взаимодействие пользователей с вашим ресурсом
displayName: Коды
order: 4
published: true
historyName: Коды
...
Здесь отображается результат взаимодействия пользователей с сервером.  
Параметры в верхней части можно изменять аналогично вкладкам [Ширина канала]([236]), [Запросы]([237]) и [География запросов]([239]).

![Filters for Response codes tab(95%)](https://img.solarspace.pro/docs/saas/statistics/statistics-codes-of-responces.png "Фильтры для вкладки «Коды»")
...
![Response codes for Response codes tab(95%)](https://img.solarspace.pro/docs/saas/statistics/statistics-codes-of-responces-2.png "Коды для вкладки «Коды»")

Нажимая на название кода, вы можете исключить его из графика.  
В этом случае название станет серым.  
Чтобы вернуть отображение, повторно нажмите на его название.
...
![Filters for Response codes tab(95%)](https://img.solarspace.pro/docs/partners/statistics/statistics-codes-of-responces.png "Фильтры для вкладки «Коды»")
...
![Response codes for Response codes tab(95%)](https://img.solarspace.pro/docs/partners/statistics/statistics-codes-of-responces-2.png "Коды для вкладки «Коды»")
